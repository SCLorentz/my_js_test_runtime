// TODO: WARN! Fix this
//https://github.com/carloslfu/make-your-own-js-runtime/blob/main/src/module_loader.rs
        ...
        fn load(
            ...
            let (code, should_transpile, media_type, module_type) =
                if module_specifier.scheme() == "file" {
                    ...
                    response = ureq::get(&url).call()?.into_string().map_err(|e| anyhow!(e.to_string()))?; // <-- error here for some reason
